...
abstract class EmbedVideo
{
    ...
    private static function generateNormalClause($url, $width, $height)
    {
        $clause = "<object width=\"{$width}\" height=\"{$height}\">" .
            ...
            " wmode=\"transparent\" allowfullscreen=\"true\" width=\"{$width}\" height=\"{$height}\">" . //HW: hint: http://www.mediawiki.org/wiki/Extension:EmbedVideo#Enabling%20full-screen%20mode%20for%20youtube
            "</embed></object>";
        return $clause;
    }
    ...
    private static function generateAlignClause($url, $width, $height, $align, $desc)
    {
        $clause = "<div class=\"thumb t{$align}\">" .
            ...
            "<param name=\"wmode\" value=\"transparent\"></param>" .
            "<embed src=\"{$url}\" type=\"application/x-shockwave-flash\"" .
            " wmode=\"transparent\" allowfullscreen=\"true\" width=\"{$width}\" height=\"{$height}\"></embed>" . //HW: hint: http://www.mediawiki.org/wiki/Extension:EmbedVideo#Enabling%20full-screen%20mode%20for%20youtube
            "</object>" .
            "<div class=\"thumbcaption\">" .
            $desc .
            "</div></div></div>";
