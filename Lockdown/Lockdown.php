...
if (!is_array($wgSpecialPageLockdown))
	$wgSpecialPageLockdown = array();
if (!is_array($wgActionLockdown))
 ...
 *
 * @global User $wgUser
 * @global type $wgNamespacePermissionLockdown
 * @param type $arr
 * @return boolean 
 */
...
function lockdownSearchEngineReplacePrefixesComplete($searchEngine, $query,
		$parsed) {
	global $wgUser, $wgNamespacePermissionLockdown;
